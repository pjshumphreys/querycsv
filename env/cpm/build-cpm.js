...
const functionsList = [
  ...
  ['_fopen_cpm', 3, 0x0001, 0x0001, 'farcall2'],
  ['fclose', 3, 0x0001, 0x0001, 'farcall2'],
  ['_fread_cpm', 3, 0x0001, 0x0001, 'farcall2'],
  ['_fwrite_cpm', 3, 0x0001, 0x0001, 'farcall2'],
  ['_fprintf_cpm', 3, 0x0001, 0x0001, 'farcall2'],
  ['_fputs_cpm', 3, 0x0001, 0x0001, 'farcall2'],
  ['_malloc_cpm', 3, 0x0001, 0x0001, 'farcall2'],
  ['_free_cpm', 3, 0x0001, 0x0001, 'farcall2'],
  ['_realloc_cpm', 3, 0x0001, 0x0001, 'farcall2'],
