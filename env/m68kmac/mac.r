...
resource 'MENU' (mApple, preload) {
	...
	enabled, apple,
	{
		"About QueryCSV...",  /* use ... instead of É for compatibility with non-roman systems */
...
resource 'MENU' (mFile, preload)
{
	...
	"File",
	{
		"Open...", noIcon, "O", noMark, plain;  /* use ... instead of É for compatibility with non-roman systems */
